        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          ...
          <nav className="flex items-center">
            <Button
              variant="ghost"
              onClick={handleAuth}
              className="mr-6 flex items-center space-x-2 text-base hover:bg-transparent focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0"
            >
              {user ? (
                <>
